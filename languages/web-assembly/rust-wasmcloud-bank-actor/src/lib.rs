...
// actor::init procedural macro creates a custom wrapper around the wapc_init function.
// This wrapper also gives us a default health check handler that is required by the wasmCloud host runtime.
#[actor::init]
fn init() {

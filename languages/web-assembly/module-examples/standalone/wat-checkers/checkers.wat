...
(module
  ...
  ;; Used to store the current turn.
  (global $currentTurn (mut i32) (i32.const 0))

  ;; Used to store global statics defining bitmaps identifiers for the state of a piece.
  (global $WHITE i32 (i32.const 2))
  (global $BLACK i32 (i32.const 1))
  (global $CROWN i32 (i32.const 4))

  ;; Convert the 8x8 cordinates into a linear index.
  ...
  ;; Convert the 8x8 coordinates into a byte offset in linear memory.
  ;; Each i32 datatype is 4 bytes long.
  ;; Calculate the index and mulitply by 4.
  ;;
  ;; Offset = ( x + y * 8 ) * 4

...
//
// * Run some tasks in the parent process using a busy loop.
//
// * Use a 'signal handler' to handle signals.
//
// * Use special 'signal safe' functions: 'print_signal_safe' and 'exit_signal_safe'.
